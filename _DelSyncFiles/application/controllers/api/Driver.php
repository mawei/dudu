...
class Driver extends API_Controller {
    ...
    function index($page_no=0,$sort_id=0)
    {
        ...
        if (isset($_GET['dosubmit'])) {
        	...
        	$data_list = $this->driver_list_model->listinfo($where,'*',$orderby , $page_no, $this->driver_list_model->page_size,'',$this->driver_list_model->page_size,page_list_url('api/driver/index',true));
        if($data_list)
        {
